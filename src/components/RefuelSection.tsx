  ...
  return (
    <div className="w-full">
      <div className="flex justify-between w-full items-center gap-2">
        ...
        <h3 className="text-sm font-body font-bold flex-1 text-left">{mpgMode === "total" ? "Total MPG" : "Recent MPG"}</h3>
        <h3 className="text-sm font-body font-bold flex-1 text-right">Fill Up</h3>
        <button
          type="button"
